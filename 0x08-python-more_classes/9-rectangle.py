...
class Rectangle:
    ...
    def __repr__(self):
        """Rstring representation of a Rectangle instance
        """
        return "Rectangle({}, {})".format(self.__width, self.__height)

    def __del__(self):
        """F a rectangle is destroyed."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1

    @property
    def width(self):
        """Rhe width of a Rectangle instance."""
        return self.__width
    ...
    @property
    def height(self):
        """ves the height of a Rectangle instance."""
